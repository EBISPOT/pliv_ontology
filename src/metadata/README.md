 ...
 * [pliv.yml](pliv.yml)
     * Determines how your purl.obolibrary.org/obo/pliv/ redirects will be handled
     ...
     * Paste in the contents of [pliv.yml](pliv.yml)
 ...
 * [pliv.md](pliv.md)
     ...
     * Paste in the contents of [pliv.md](pliv.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
